                ...
                <div class="container-fluid d-flex align-items-center justify-content-between px-2 px-md-4">
                    ...
                    <div class="dropdown">
                        ...
                        <ul
                            ...
                            <li><router-link class="dropdown-item rounded-2 text-white py-2" to="/Staff/Profile"><i
                                        class="bi bi-person me-2"></i> Profile</router-link></li>
                            <li><router-link class="dropdown-item rounded-2 text-white py-2" to="/Staff/Settings"><i
                                        class="bi bi-gear me-2"></i> Settings</router-link></li>
                            <li>
