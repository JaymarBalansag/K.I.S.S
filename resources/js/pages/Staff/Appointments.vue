                                ...
                                <tr v-for="apt in appointments" :key="apt.id" class="glass-row transition">
                                    ...
                                    <td class="text-center border-0 rounded-end-4 px-4">
                                        <div class="d-flex justify-content-center gap-2">
                                            <button @click="viewDetails(apt.id)" class="btn btn-action-glass text-info">
                    ...
                    <div class="d-md-none px-2">
                        <div v-for="apt in appointments" :key="'mob-' + apt.id"
                            ...
                            <div class="d-flex gap-2">
                                <button @click="viewDetails(apt.id)" class="btn btn-action-glass text-info flex-grow-1">
...
export default {
    ...
    methods: {
        ...
        approveAppointment(id) {
            if (confirm("Confirm approval for this appointment schedule?")) {
