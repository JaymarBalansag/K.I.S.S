      ...
      <div class="container py-2 py-md-5 mt-5">
        ...
        <div class="row justify-content-center text-center mb-4 mt-2">
          <div class="col-lg-9 col-xl-8">
            ...
            <p class="text-white fw-medium opacity-75 d-none d-md-block">Select a preferred date for your ceremony. Click again to deselect.</p>
          </div>
        </div>
            ...
            <div class="card border-0 shadow-lg glass-card overflow-hidden">
              ...
              <div class="calendar-header p-3 p-md-4 border-bottom bg-dark bg-opacity-10">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                  ...
                  <div class="d-flex align-items-center gap-2 order-2 order-md-1">
                    ...
                    <button @click="changeMonth(-1)" class="btn btn-primary shadow-sm rounded-circle p-2 d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
              ...
              <div class="card-body p-0">
                <div class="d-grid calendar-grid border-bottom bg-white bg-opacity-75">
                  <div v-for="day in weekDays" :key="day" class="py-2 py-md-3 text-center fw-bold text-primary small text-uppercase">
                    {{ day }}
                  </div>
                </div>

                <div class="d-grid calendar-grid bg-white bg-opacity-25">
                  <div v-for="blank in firstDayPadding" :key="'blank-'+blank" class="calendar-day padding d-none d-md-flex"></div>
              ...
              <div class="p-3 p-md-4 bg-white bg-opacity-75 border-top d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                <div class="selected-info text-center text-md-start">
                  <transition name="fade" mode="out-in">
                    ...
                    <span v-else class="text-muted italic small">Select a day on the calendar to proceed</span>
                  </transition>
                </div>
                
                <div class="d-flex w-100 w-md-auto gap-2">
                  <button v-if="selectedDate" @click="selectedDate = null" class="btn btn-outline-danger rounded-pill px-3 px-md-4 fw-bold">
                    Clear
                  </button>
                  <button 
                    class="btn btn-primary rounded-pill px-4 px-md-5 fw-bold shadow flex-grow-1" 
...
@media (max-width: 576px) {
  .calendar-day {
    aspect-ratio: 1 / 1.2; /* Slightly taller on mobile for easier tapping */
  }
  .day-number { font-size: 0.9rem; }
  .selection-mark { font-size: 0.6rem; top: 2px; right: 2px; }
